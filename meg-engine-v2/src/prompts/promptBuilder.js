...
function buildMegPrompt({ intent = 'casual', context = {}, memories = [], recentMessages = [], message, language = 'en', tokenBudget = 4200, promptVersion = 'meg-prompt-v2' } = {}) {
  ...
  const sections = fitSections([
    ...
    { name: 'turnMetadata', text: `Current intent: ${intent}. Language: ${language || 'en'}. Prompt version: ${promptVersion}.`, maxTokens: 100 },
